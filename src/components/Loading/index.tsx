...
const Loading = (
  ...
  const containerClass = type === 'app' ? 'loading-app-fullscreen' : 'flex w-full justify-center items-center';
  const iconSize = type === 'app' ? 24 : 16;

  return (
    <div className={containerClass}>
      <svg width={iconSize} height={iconSize} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className='spin-animation'>
